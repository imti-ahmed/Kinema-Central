import svgPaths from "./svg-wlxrlqcme8";
import imgRectangle2 from "figma:asset/716f2f1afe00ecf3e01e5d1ea8c32e7b271e8dc3.png";

function Frame65() {
  return (
    <div className="box-border content-stretch flex flex-row font-['Archivo:Regular',_sans-serif] font-normal gap-1 items-center justify-start leading-[0] p-0 relative shrink-0 text-[#df3b3b] text-[8px] text-left text-nowrap w-[93.246px]">
      <div
