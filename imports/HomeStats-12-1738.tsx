import svgPaths from "./svg-csm5d843mk";
...
function Frame6() {
  return (
    <div className="absolute box-border content-stretch flex flex-row items-center justify-between left-1/2 pb-4 pt-6 px-6 top-0 translate-x-[-50%] w-[1280px]">
...
function Frame15() {
  return (
    <div className="absolute box-border content-stretch flex flex-row items-center justify-between left-1/2 pb-4 pt-3 px-6 top-[58px] translate-x-[-50%] w-[1280px]">
      <div className="absolute border-[#ffebeb] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Frame14 />
    </div>
  );
...
function Frame20() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        className="font-['Archivo:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#df3b3b] text-[10px] text-left text-nowrap"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Category</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[95px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Entries</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Total Entries</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[95px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">300</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Movies</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">TV Shows</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Movie Watchlist</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">TV Watchlist</p>
      </div>
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start justify-start left-6 pb-px pt-0 px-0 top-[139px] w-[292px]">
      <Frame31 />
      <Frame16 />
      <Frame39 />
      <Frame18 />
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">User Name</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[95px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Shows</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[95px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Show Watchlist</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Imti</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Shivraj</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Shivani</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Manisha</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Manit</p>
      </div>
    </div>
  );
}
...
function Frame148() {
  return (
    <div className="relative size-4" data-name="Frame">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
    ...
    <div className="box-border content-stretch flex flex-row gap-1.5 items-center justify-start p-0 relative shrink-0">
      ...
      >
        <p className="leading-[normal] whitespace-pre">
          ...
          <span>{`   1   `}</span>
          <span className="text-[#ffc0c0]">{`2   3   4  ...  16`}</span>
          <span>{`    Next `}</span>
        </p>
      </div>
...
function Frame150() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start justify-start left-[340px] pb-px pt-0 px-0 top-[139px] w-[912px]">
      <Frame50 />
      <Frame54 />
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 h-[41.045px] items-center justify-start px-[19px] py-3 relative w-full">
          <div
            ...
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[normal] whitespace-pre">MVP Users</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Most Movies</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Most TV Shows</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[99px] items-center justify-start p-0 relative shrink-0 w-[104px]">
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[normal] whitespace-pre">Most Watchlist</p>
      </div>
    </div>
  );
}
...
function Frame164() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start justify-start left-6 pb-px pt-0 px-0 top-[384.045px] w-[292px]">
      <Frame151 />
      <Frame154 />
      <Frame157 />
      <Frame160 />
...
export default function HomeStats() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="Home - Stats">
      <Frame6 />
      <Frame15 />
      <Frame49 />
      <Frame150 />
