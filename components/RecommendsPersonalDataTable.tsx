...
const recommendsData: RecommendEntry[] = [];
...
interface RecommendsPersonalDataTableProps {
  activePersonalTab: 'watched' | 'watchlist' | 'recommends';
  onPersonalTabChange: (tab: 'watched' | 'watchlist' | 'recommends') => void;
}

function TableTitle({ activePersonalTab, onPersonalTabChange }: RecommendsPersonalDataTableProps) {
  return (
...
function TableRow({ entry }: { entry: RecommendEntry }) {
  return (
...
export function RecommendsPersonalDataTable({ activePersonalTab, onPersonalTabChange }: RecommendsPersonalDataTableProps) {
  return (
